...
# This project uses our webcam and tries to detect and, if possible, recognize the
# faces in view.

# To speed things up, we will use 1/4 the resolution of our camera and skip
# every-other frame.
...
# create an array of know face encodings and their names
known_face_encodings = [todd_face_encoding, damian_face_encoding, jiho_face_encoding]
known_face_names = ["Todd A.", "Damian M.", "Jiho S."]
